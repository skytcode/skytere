...
rm -f src/config/skytere-config.h
...
rm -rf test_bitcoin.coverage/ skytere-gtest.coverage/ total.coverage/
...
clean_exe src/skytere-cli
clean_exe src/skytered
clean_exe src/skytere-gtest
clean_exe src/skytere-tx
clean_exe src/test/test_skytere
clean_exe src/test/test_skytere_fuzzy
...
clean_dep . src/config/skytere-config.h.in
