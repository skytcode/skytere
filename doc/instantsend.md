...
This mechanism has been integrated into Bitcore-Node-Skytere which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/skytcode/insight-api-skytere#web-socket-api](https://github.com/skytcode/insight-api-skytere#web-socket-api)
* API: [https://github.com/skytcode/insight-api-skytere#instantsend-transactions](https://github.com/skytcode/insight-api-skytere#instantsend-transactions)
