...
This document provides guidelines for internationalization of the Skytere Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `skytere_en.ts` remains unchanged.
