...
* skytere.conf: contains configuration settings for skytered or skytere-qt
* skytered.pid: stores the process id of skytered while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by skytered or skytere-qt
