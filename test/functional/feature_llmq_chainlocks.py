...
from test_framework.test_framework import SkytereTestFramework
...
class LLMQChainLocksTest(SkytereTestFramework):
    def set_test_params(self):
        self.set_skytere_test_params(6, 5, fast_dip3_enforcement=True)
