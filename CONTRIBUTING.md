Contributing to Skytere Core
============================

The Skytere Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/skytcode/skytere/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Skytere Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Skytere
Network Protocol consensus changes.

Whether a pull request is merged into Skytere Core rests with the project merge
...
Patches that change Skytere consensus rules are considerably more involved than
...
Where a patch set proposes to change the Skytere consensus, it must have been
...
The review process is normally fairly responsive on the Skytere Core repository, however
...
The project leader is the release manager for each Skytere Core release.
