...
//! Interface for the src/evo part of a skytere node (skytered process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a skytere node (skytered process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a skytere node (skytered process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a skytere node (skytered process).
class Node
{
public:
    virtual ~Node() {}
