...
#ifndef SKYTERE_ARITH_UINT256_H
#define SKYTERE_ARITH_UINT256_H
...
public:
     ...
     *
     * Skytere only uses this "compact" format for encoding difficulty
