...
{
    const char* pszTimestamp = "The Skytere blockchain A new alternative in the world of cryptocurrencies 81357a236";
    const CScript genesisOutputScript = CScript() << ParseHex("042f5e916be9f2539f27e790598bcdf2065571dd568e733dde65a21d9bfd4e11a41d76bc8b2e61bfc686c35b88a0aed7f2d97387d222938aa7dd463d4f9f91d59c") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nSmartnodePaymentsStartBlock = 5040; //
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Skytere: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Skytere: 2 minutes
        ...
        consensus.defaultAssumeValid = uint256S("0x3373a077a935f6e24b7c9b217e740fdcdcbeebeec75289bbdfeb833926db095d"); // block hash for 0
        ...
        genesis = CreateGenesisBlock(1693243607, 537, 0x20001fff, 4, 5000 * COIN);
        ...
        // Skytere private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Skytere BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Skytere BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Skytere BIP44 coin type is '5'
...
//        }
        ...
        vSporkAddresses = {"STW7JkdxJ7QcwqXArKB54yx5kvW2N9AwA7"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1693243607,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Skytere: 1 day
        consensus.nPowTargetSpacing = 60; // Skytere: 1 minutes
        ...
        vSeeds.emplace_back("netest.skytere.com");

        // Testnet Skytere addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,123);
        // Testnet Skytere script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Skytere BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Skytere BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Skytere BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        consensus.nFounderPayment = FounderPayment(rewardStructures, 272200, "rk8NwysDeprg4M93bPuJzCuiFdNCmokK4S");
        ...
        vSporkAddresses = {"rk8NwysDeprg4M93bPuJzCuiFdNCmokK4S"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;
        ...
        chainTxData = ChainTxData{
            1693243607, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
//      std::cout << "hash: " << consensus.hashGenesisBlock.ToString() << std::endl;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("skytereevo.org",  "devnet-seed.skytereevo.org"));

        // Testnet Skytere addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Skytere addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Skytere script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Skytere BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Skytere BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Skytere BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
