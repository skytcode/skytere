...
/* SkytereGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* SkytereGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Skytere"
#define QAPP_ORG_DOMAIN "skytere.com"
#define QAPP_APP_NAME_DEFAULT "Skytere-Qt"
#define QAPP_APP_NAME_TESTNET "Skytere-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Skytere-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Skytere-Qt-regtest"
