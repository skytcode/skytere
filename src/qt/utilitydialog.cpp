    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  skytere-qt [command-line options]                     \n";
...
All the Skytere in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 SKYT, 0.01 SKYT, 0.1 SKYT, 1 SKYT and 10 SKYT -- sort of like the paper money you use every day.</li> \
