...
/** Utility functions used by the Skytere Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "skytere:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load skytere specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a skytere specific theme is activated (light/dark).*/
