...
official/supported Docker Images found at https://hub.docker.com/r/skytere/skytered/
...
**NOTE: Please update the image description at https://hub.docker.com/r/skytere/skytered-develop/ when changing the above text**